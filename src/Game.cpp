...
//	mShip->SetScale(1.5f);
	...
	std::vector<SDL_Texture*> bgtexs = {
		GetTexture(RESOURCES_PATH"Assets/Farback01.png"),
		GetTexture(RESOURCES_PATH"Assets/Farback02.png")
	};
	...
	bg->SetScreenSize(Vector2(1024.0f, 768.0f));
	bgtexs = {
		GetTexture(RESOURCES_PATH"Assets/Stars.png"),
		GetTexture(RESOURCES_PATH"Assets/Stars.png")
	};
	bg->SetBGTextures(bgtexs);
...
//    SDL_Log("Getting Texture: %s", fileName.c_str());
	...
	{
		// Load from file
		SDL_Surface* surf = STBIMG_Load(fileName.c_str());
		if (!surf)
		{
